    ...
    <div class="content">
      <div class="item">
        ...
        <div class="item-text wrapped mt-8">
          ...
          jede Angabe personenbezogener Daten möglich. Sofern eine betroffene Person besondere Services unseres Vereins
          ...
          Übereinstimmung mit den für die Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V. geltenden
          landesspezifischen Datenschutzbestimmungen. Mittels dieser Datenschutzerklärung möchte unser Verein die
          Öffentlichkeit über Art, Umfang und Zweck der von uns erhobenen, genutzten und verarbeiteten personenbezogenen
          Daten informieren. Ferner werden betroffene Personen mittels dieser Datenschutzerklärung über die ihnen
          zustehenden Rechte aufgeklärt.
          <br/><br/>
          Die Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V. hat als für die Verarbeitung
        ...
        <div class="item-text wrapped mt-8">
          ...
          Öffentlichkeit als auch für unsere Mitglieder und Gäste einfach lesbar und verständlich sein. Um dies zu
        ...
        <div class="item-text wrapped mt-8">
          ...
          <br/>
          <br/>Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V.
          <br/>Postfach 1028
          <br/>25310 Elmshorn
          <br/>Deutschland
          <br/>Tel.: 01749393321
        ...
        <div class="item-text wrapped mt-8">
          ...
          Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Schützenbrüderschaft Weidmannsheil Klein
          Nordende Lieth v. 1919 e.V. keine Rückschlüsse auf die betroffene Person. Diese Informationen werden vielmehr
          benötigt, um (1) die Inhalte unserer Internetseite korrekt auszuliefern, (2) die Inhalte unserer Internetseite
          ...
          bereitzustellen. Diese anonym erhobenen Daten und Informationen werden durch die Schützenbrüderschaft
          Weidmannsheil Klein Nordende Lieth v. 1919 e.V. daher einerseits statistisch und ferner mit dem Ziel
          ausgewertet, den Datenschutz und die Datensicherheit in unserem Verein zu erhöhen, um letztlich ein optimales
        ...
        <div class="item-text wrapped mt-8">
          ...
          <br/>Entfällt der Speicherungszweck oder läuft eine vom Europäischen Richtlinien- und Verordnungsgeber oder
          einem
        ...
        <div class="item-text wrapped mt-4">
          ...
          2 die Empfänger oder Kategorien von Empfängern, gegenüber denen die personenbezogenen Daten offengelegt worden
          ...
          1 das Bestehen eines Rechts auf Berichtigung oder Löschung der sie betreffenden personenbezogenen Daten oder
          ...
          3 wenn die personenbezogenen Daten nicht bei der betroffenen Person erhoben werden: Alle verfügbaren
          Informationen über die Herkunft der Daten
          4 das Bestehen einer automatisierten Entscheidungsfindung einschließlich Profiling gemäß Artikel 22 Abs.1 und
          4 DS-GVO und - zumindest in diesen Fällen - aussagekräftige Informationen über die involvierte Logik sowie die
          Tragweite und die angestrebten Auswirkungen einer derartigen Verarbeitung für die betroffene Person Ferner
          steht der betroffenen Person ein Auskunftsrecht darüber zu, ob personenbezogene Daten an ein Drittland oder an
          eine internationale Organisation übermittelt wurden. Sofern dies der Fall ist, so steht der betroffenen Person
        ...
        <div class="item-text wrapped mt-4">
          ...
          1 Die betroffene Person widerruft ihre Einwilligung, auf die sich die Verarbeitung gemäß Art. 6 Abs. 1
          Buchstabe a DS-GVO oder Art. 9 Abs. 2 Buchstabe a DS-GVO stützte, und es fehlt an einer anderweitigen
          Rechtsgrundlage für die Verarbeitung.
          2 Die betroffene Person legt gemäß Art. 21 Abs. 1 DS-GVO Widerspruch gegen die Verarbeitung ein, und es liegen
          ...
          4 Die Löschung der personenbezogenen Daten ist zur Erfüllung einer rechtlichen Verpflichtung nach dem
          Unionsrecht oder dem Recht der Mitgliedstaaten erforderlich, dem der Verantwortliche unterliegt.
          5 Die personenbezogenen Daten wurden in Bezug auf angebotene Dienste der Informationsgesellschaft gemäß Art. 8
          Abs. 1 DS-GVO erhoben. Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung
          von personenbezogenen Daten, die bei der Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V.
          gespeichert sind, veranlassen möchte, kann sie sich hierzu jederzeit an ein Vorstandsmitglied des für die
          Verarbeitung Verantwortlichen wenden. Das Vorstandsmitglied der Schützenbrüderschaft Weidmannsheil Klein
          Nordende Lieth v. 1919 e.V. wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird. Wurden
          die personenbezogenen Daten von der Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V.
          öffentlich gemacht und ist unser Verein als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
          personenbezogenen Daten verpflichtet, so trifft die Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v.
          1919 e.V. unter Berücksichtigung der verfügbaren Technologie und der Implementierungskosten angemessene
        ...
        <div class="item-text wrapped mt-4">
          ...
          <br/>(1) Die Verarbeitung ist unrechtmäßig, die betroffene Person lehnt die Löschung der
          personenbezogenen Daten
          ab
          und verlangt stattdessen die Einschränkung der Nutzung der personenbezogenen Daten.
          <br/>(2) Der Verantwortliche benötigt die personenbezogenen Daten für die Zwecke der
          ...
          <br/>(3) Die betroffene Person hat Widerspruch gegen die Verarbeitung gem. Art. 21 Abs. 1
          DS-GVO eingelegt und
          es
          steht noch nicht fest, ob die berechtigten Gründe des Verantwortlichen gegenüber denen der betroffenen Person
          überwiegen. Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person die
        ...
        <div class="item-text wrapped mt-4">
          ...
          Die Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V. verarbeitet die personenbezogenen
          ...
          <br/>
          Verarbeitet die Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V. personenbezogene Daten,
          um Direktwerbung zu betreiben, so hat die betroffene Person das Recht, jederzeit Widerspruch gegen die
          ...
          gegenüber der Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V. der Verarbeitung für Zwecke
          der Direktwerbung, so wird die Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V. die
          ...
          gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei der Schützenbrüderschaft Weidmannsheil
          Klein Nordende Lieth v. 1919 e.V. zu wissenschaftlichen oder historischen Forschungszwecken oder zu
          statistischen Zwecken gemäß Art. 89 Abs. 1 DS-GVO erfolgen, Widerspruch einzulegen, es sei denn, eine solche
          Verarbeitung ist zur Erfüllung einer im öffentlichen Interesse liegenden Aufgabe erforderlich. Zur Ausübung
          des Rechts auf Widerspruch kann sich die betroffene Person direkt an jedes Vorstandsmitglied der
          Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V. wenden. Der betroffenen Person steht es
        ...
        <div class="item-text wrapped mt-4">
          ...
          <br/>(1) nicht für den Abschluss oder die Erfüllung eines Vertrags zwischen der betroffenen Person und dem
          Verantwortlichen erforderlich ist, oder
          <br/>(2) aufgrund von Rechtsvorschriften der Union oder der Mitgliedstaaten, denen der Verantwortliche
          unterliegt, zulässig ist und diese Rechtsvorschriften angemessene Maßnahmen zur Wahrung der Rechte und
          Freiheiten sowie der berechtigten Interessen der betroffenen Person enthalten oder
          <br/>(3) mit ausdrücklicher Einwilligung der betroffenen Person erfolgt.
          ...
          Person, trifft die Schützenbrüderschaft Weidmannsheil Klein Nordende Lieth v. 1919 e.V. angemessene Maßnahmen,
          um die Rechte und Freiheiten sowie die berechtigten Interessen der betroffenen Person zu wahren, wozu
        ...
        <div class="item-text wrapped mt-8">
          ...
          beispielsweise bei Verarbeitungsvorgängen der Fall ist, die für die Mitgliedschaft oder die Erbringung einer
          ...
          sind, etwa in Fällen von Anfragen zu unseren Leistungen. Unterliegt unser Verein einer rechtlichen
          Verpflichtung, durch welche eine Verarbeitung von personenbezogenen Daten erforderlich wird, wie
          beispielsweise zur Erfüllung steuerlicher Pflichten, so basiert die Verarbeitung auf Art. 6 I lit. c DS-GVO.
          ...
          der Fall, wenn ein Besucher in unserem Vereinsheim (Schützenhalle) verletzt werden würde und daraufhin sein
          Name, sein Alter, seine Krankenkassendaten oder sonstige lebenswichtige Informationen an einen Arzt, ein
          ...
          werden, wenn die Verarbeitung zur Wahrung eines berechtigten Interesses unseres Vereins oder eines Dritten
        ...
        <div class="item-text wrapped mt-8">
          ...
          Verein mit ihr einen Vertrag abschließt. Eine Nichtbereitstellung der personenbezogenen Daten hätte zur Folge,
          dass der Vertrag mit dem Betroffenen nicht geschlossen werden könnte. Vor einer Bereitstellung
          personenbezogener Daten durch den Betroffenen muss sich der Betroffene an ein Vorstandsmitglied wenden. Dieser
          klärt den Betroffenen einzelfallbezogen darüber auf, ob die Bereitstellung der personenbezogenen Daten
